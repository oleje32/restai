...
DB_POOL_SIZE = int(os.environ.get("DB_POOL_SIZE") or 50)
DB_MAX_OVERFLOW = int(os.environ.get("DB_MAX_OVERFLOW") or 100)
DB_POOL_RECYCLE = int(os.environ.get("DB_POOL_RECYCLE") or 100)
